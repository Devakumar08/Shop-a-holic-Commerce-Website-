# Generated by Django 4.2.4 on 2023-10-25 06:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('delivered', 'delivered'), ('packed', 'packed'), ('cancel', 'cancel'), ('on the way', 'on the way'), ('accepted', 'accepted')], default='Pending', max_length=50)),
